    ...
    \section*{O Programa}
        ...
        \subsection*{Arquivos}
            ...
            \begin{description}
                ...
                \item[\texttt{EP1}] Executável, criado com o comando \texttt{make}.
                \item[\texttt{EP1.pdf}] Relatório, criado com o comando \texttt{make tex}.
                \item[\texttt{Makefile}]
            \end{description}
            ...
            \begin{description}
                ...
                \item[\texttt{obj/}] Criado durante a compilação, guarda os arquivos objetos (\texttt{.o}) e módulos (\texttt{.mod}). É excluído com o comando \texttt{make clean}.
                \item[\texttt{tex/}] Contém o código fonte deste relatório (\texttt{.tex}) e a bibliografia (\texttt{.bib}).
                \item[\texttt{aux/}] Criado durante a compilação, guarda os arquivos auxiliares do \LaTeX  e do \texttt{BibTeX}. É excluído com o comando \texttt{make clean}.
            \end{description}
    \section*{Resultados}
    \section*{Conclusão}
